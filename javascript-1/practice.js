...
// Create a function called 'iLove' that takes in two string parameters, 'name' and 'love'. Have the function take the two parameters and return a string that says
...
//Code Here
console.log(colorCopy.push('gold', 'blue'))
...
// Code Here
const total = myNumbers.reduce(function(acc, cur, element){
	return acc+cur
...
const forTheLoveOfGeorge = notGeorge.map(function(element,index,array){
	if(element != 'George'){
		return notGeorge[element] = 'George'
	}
