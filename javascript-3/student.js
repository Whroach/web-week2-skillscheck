...
const groceries =['oranges', 'apple', 'milk'];
...
function checkGroceryCount(groceries){
    if(console.log(groceries.length) >= 5){
        return " That looks like a big trip"

    }
    else if(console.log(groceries.length) = 1){
        return "1 item"
    }
    else if(console.log(groceries.length) > 1 && console.log(groceries.length) < 5){
        let totalGro = "";

        return totalGro = addItem() - removeItem()
    }
}
